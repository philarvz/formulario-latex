...
% -------------------- Portada --------------------
\title{
\textbf{Reporte de matemáticas} \\[0.5em]
\textit{Integradora}
}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{mate.jpg} % Cambia si tu imagen tiene otro nombre
    \caption{Portada del formulario de matemáticas}
    \label{fig:portada}
\end{figure}
...
\subsection{Funciones escalares de varias variables}
