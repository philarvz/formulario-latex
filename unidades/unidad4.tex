\section{Unidad 4: Funciones vectoriales e integral de línea}
...
\subsubsubsection{Definición y análisis geométrico}
...
\subsubsubsection{Propiedades fundamentales}
...
\subsubsubsection{Teoremas esenciales}
...
\subsubsubsection{Aplicaciones matemáticas}
...
\subsubsubsection{Aplicaciones físicas}
...
\subsubsubsection{Reparametrización por longitud de arco}
...
\subsubsubsection{Regularidad y suavidad de curvas}
...
\subsubsubsection{Curvatura y vector normal}
...
\subsubsubsection*{Coordenadas polares}
...
\subsubsubsection*{Coordenadas cilíndricas}
...
\subsubsubsection*{Coordenadas esféricas}
...
\subsubsubsection*{Curva braquistócrona}
...
\subsubsubsection*{Simetría respecto al eje \(x\)}
...
\subsubsubsection*{Simetría respecto al eje \(y\)}
...
\subsubsubsection*{Simetría central}
...
\subsubsubsection*{Auto–intersecciones}
...
\subsubsubsection*{Intersecciones entre superficies}
...
\subsubsubsection*{Curvas de nivel parametrizadas}
...
\subsubsubsection*{Curvas como soluciones de EDO}
...
\subsubsubsection*{Curvas de mínima energía}
...
\subsubsubsection*{Movimiento bajo fuerzas centrales}
...
\subsubsubsection*{Trayectorias de partículas cargadas}
...
\subsubsubsection*{Curvas planas}
...
\subsubsubsection*{Curvas espaciales generalizadas}
...
\subsubsubsection*{Trabajo en campos gravitacionales}

\[
W = \int_C m\vec g\cdot d\vec r = mg(z_B - z_A).
\]

\subsubsubsection*{Trabajo en campos eléctricos}
...
\subsubsubsection*{Circulación en dinámica de fluidos}
